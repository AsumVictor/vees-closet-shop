...
function FAQPage() {
  ...
  return (
    <div className={`${styles.section} my-8 mt-20`} id="faq">
      ...
      <div className="mx-auto space-y-4">
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@mvees.com, or by calling us at 054000000
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          >
            <span className="text-lg font-medium text-gray-900 text-left">
              Which region do you offer your services?
            </span>
            {activeTab === 6 ? (
              <svg
                className="h-6 w-6 text-gray-500"
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept MTN, Vodafone, Airtel Tigo payment method also we have
