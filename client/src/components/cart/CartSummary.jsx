  ...
  return (
    <div className="pt-1 pb-5 shadow-2xl 800px:sticky 800px:top-[2.5cm] bg-white w-full px-2 550px:w-11/12 md:w-10/12 rounded-md">
      ...
      <div className="flex flex-row justify-between items-center py-2">
        ...
        <span className="font-bold text-xl">GH₵ 300.00</span>
      </div>
      <hr className="mt-2" />
      ...
      <hr className="mt-1" />
      <button className="py-1 w-full bg-wine_primary rounded-md text-white font-bold mt-3">{`CHECKOUT (GH₵ 300.00)`}</button>
    </div>
  );
}
