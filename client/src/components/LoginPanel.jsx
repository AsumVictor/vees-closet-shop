...
export function SignupPanel() {
  ...
  <h1 className='text-3xl font-bold text-wine_primary'>Vees</h1>
          ...
          <p className='w-full md:w-9/12 mt-4'>Our store offers stylish apparel and accessories that match your unique taste. Join our community and experience the ultimate convenience of online shopping at its finest.</p>
          <Lottie
            animationData={ShopingAnim}
            loop={true}
           className='w-full md:w-10/12 mt-10'
