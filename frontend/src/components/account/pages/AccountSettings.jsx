        ...
        <div className="w-full">
            ...
            <div className="w-full flex flex-row mt-7 pr-10 gap-4 px-3 items-end justify-between">
                ...
                <button
                    ...
                    type="button"
                    className={`${
                        editable ? 'bg-red-100 text-red-600' : 'bg-deep-primary text-white  '
           ...
           gap-2`}
            ...
            >
                {error && <p className="text-red-800 text-center bg-red-100 py-1">{error}</p>}
                ...
                <div className="">
                    ...
                    {editable ? (
                        ...
                        <p className="w-full outline-0 text-xl font-medium">{user.first_name}</p>
                    )}
                ...
                <div className="">
                    ...
                    {editable ? (
                        ...
                        <p className="w-full outline-0 text-xl font-medium">{user.last_name}</p>
                    )}
                    <hr className={`mt-2 ${editable && 'border-deep-primary'} `} />
                </div>
                <div className="w-full">
