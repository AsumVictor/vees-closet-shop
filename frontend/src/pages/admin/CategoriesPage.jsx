...
function CategoriesPage() {
  const { isLoading, isError, isVariation, category } = useSelector(
  ...
  return (
    <div className="w-full py-1 ">
      ...
      <div className="mt-5 flex flex-wrap gap-5">
       ...
       <span key={c._id} className=" capitalize py-2 px-3 rounded-md bg-emerald-500 text-white font-semibold">
  {c.name}
        </span>
       )) 
        }
