...
function SpecificProduct() {
    ...
    const fetchProducts = async () => {
        try {
            setLoading(true);
            let res = await axios(`${server}product/get-product-ebece57326214432/${id}`);
            if (res.data.success) {
    ...
    const VariationChangeAdd = (variation) => {
        let duplicate = product.variations.some((i) => i.variation._id === variation._id);
                ...
                <div className="w-full py-1  col-span-full 1000px:col-span-8 1300px:col-span-7">
                    ...
                    <div className="w-full">
                        ...
                        <div className="w-full grid grid-cols-12">
                            ...
                            />
                            <UpdateButton field={'name'} data={product.name} id={product._id} />
                        </div>
                    </div>
                    ...
                    <div className="w-full mt-5">
                        <div className="w-full flex flex-row gap-2">
                            ...
                            />
                            <label htmlFor="isFeatured">Does this product has variations ?</label>
                            <UpdateButton
                                classExtnd={'w-[3cm]'}
                                field={'hasVariations'}
                    ...
                    <div className="w-full mt-5">
                        ...
                        <div className="w-full flex flex-row gap-2">
                            <input
                                ...
                                onChange={(e) => handleProductUpdate('base_price', e.target.value)}
                            />
                ...
                <div className="w-full py-1 col-span-full 1000px:col-span-4 1300px:col-span-5 ">
                    ...
                    <div className="relative px-3 justify-center flex flex-row flex-wrap gap-2 gap-y-5">
                        {product.images.map((image) => (
                            <ProductImage
                                handleIMageDelete={() => deleteImage(image._id, image.public_id)}
